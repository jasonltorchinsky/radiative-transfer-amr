...
def mass_matrix(self, mesh: Mesh, **kwargs) -> sp._coo.coo_matrix:
    ...
    if kwargs["verbose"]:
        ...
        msg: str = ( "Constructing Mass Matrix...\n" )
        utils.print_msg(msg)
    ...
    for col_key in col_keys_local:
        col_mtx: sp._csr.csr_matrix = calc_col_matrix(mesh, col_key, self.kappa)
    ...
    if kwargs["verbose"]:
        ...
        msg: str = ( "Constructed Mass Matrix\n" +

...
def split_vector(vector: PETSc.Vec, intr_mask: np.ndarray) -> list:
    ...
    ii_0, ii_f = vector.getOwnershipRange()
    ...
    vector_intr: PETSc.Vec = vector.getSubVector(iset = intr_IS)
    vector_bdry: PETSc.Vec = vector.getSubVector(iset = bdry_IS)
    
    return [vector_intr, vector_bdry]
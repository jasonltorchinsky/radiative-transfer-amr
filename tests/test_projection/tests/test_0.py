...
from .test_funcs import func_2D_0, func_2D_1
...
def test_0(dir_name = 'test_mesh'):
    ...
    proj = dg.projection.Projection(mesh, func_2D_1)
    ...
    file_name = os.path.join(proj_dir, 'proj_2d_{}.png'.format(nrefs))
    dg.projection.utils.plot_projection(proj, ax = None, file_name = file_name,

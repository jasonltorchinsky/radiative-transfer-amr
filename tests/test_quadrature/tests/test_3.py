...
def test_3(func, src_nnodes = 41, trgt_nnodes = 10, dir_name = 'test_quad'):
    """
    Tests the projection of an analytic function f onto the
    ...
    title_str = ('1-D Function Projection Between\n'
                 + 'Legendre-Gauss-Lobatto Nodal Bases\n'
                 + 'Source Order: {}\n'
                 + 'Target Order: {}').format(src_nnodes, trgt_nnodes)
    ax.set_title(title_str)

    file_name = 'lgl_proj_1d_{:03d}_{:03d}.png'.format(src_nnodes, trgt_nnodes)
